...
export default function HeroText() {
  ...
  return (
    <div className="pt-[8rem] lg:pt-[20rem] 2xl:pt-[35rem] lg:pl-[10.4rem] mx-auto lg:mx-0 text-left sm:text-center lg:text-left">
      ...
      <div className="mx-0 sm:mx-auto lg:mx-0 mt-[2.7rem] sm:mt-[3.2rem] w-[17.6rem] sm:w-[20rem] lg:w-full">
        <ContactUsButton/>
      </div>
    </div>
  )
