// src/app/components/RentIt/PlanCard/PlanCardFeatures.tsx
    ...
    >
      {features.map((f, i) => (
        <li key={i} className="flex items-center gap-[1.4rem]">
          ...
          >
            <Icon icon="ic:round-check" width="20" height="20" className={popular ? "text-black" : "text-white"} />
          </div>
          <span className="text-[1.4rem] sm:text-[1.6rem] font-medium">
            {t(f as string, { default: f })}
          </span>
        </li>
      ))}
    </ul>
