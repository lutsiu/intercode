  ...
  return (
    <article
      className={`
        ...
        ${period === "monthly" ? "min-h-[54.3rem] max-h-[54.3rem]" : "min-h-[57.3rem] max-h-[57.3rem]"}
        ...
        ${popular ? "bg-gradient-to-b from-[#9BC3FF] to-[#186AE5] text-white" : "bg-white border-[#D4D2E3] text-black"}
      `}
    >
