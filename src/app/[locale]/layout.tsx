...
import GtagPageView from "@/app/components/Common/Analytics/GtagPageView"; // 👈 add
...
const GA_ID = process.env.NEXT_PUBLIC_GA_ID; // 👈 from .env.local
...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale}>
      ...
      >
        {/* GA loader (once). Safe in Server Component. */}
        {GA_ID && (
          <>
            <Script
